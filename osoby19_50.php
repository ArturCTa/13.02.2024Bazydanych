...
<h2>Autor: Artur Kionka</h2>
    ...
    <div class="counter">
        <?php
            $counter_records = $conn -> query("SELECT COUNT(bez_tytu__u_1.ID) as 'ile' FROM bez_tytu__u_1 WHERE wiek BETWEEN 19 and 50;");
    ...
    <div class="all">
        <ul>
        <?php
    $all_records = $conn->query("SELECT bez_tytu__u_1.ID,bez_tytu__u_1.IMIE,bez_tytu__u_1.NAZWISKO,bez_tytu__u_1.WIEK from bez_tytu__u_1 WHERE wiek BETWEEN 19 and 50;");
